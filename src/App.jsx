	...
	return (
		<div className="container mt-3">
			...
			{currentListType === 'items' && <>
				<AddItem currentListType={currentListType} />
				<List items={itemList} setItemList={setItemList} />
			</>}
			{currentListType === 'appointments' && <>
				<AddItem currentListType={currentListType} />
				<List items={appointmentList} setItemList={setAppointmentList} />
			</>}
			{currentListType === 'checklist' && <>
				<AddItem currentListType={currentListType} addItem={addToChecklist} />
				<List items={checklist} setItemList={setChecklist} />
			</>}
